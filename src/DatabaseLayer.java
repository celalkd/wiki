...
public class DatabaseLayer {
	...
	public void build(){
		try {
			archieve.getMovies(fileIO.fileToString("top250_10film"));//wikiLink, id ve yapým yýlý
			archieve.checkMovies(fileIO.fileToString("top250_info_10film"));//infobox(title, director, starring), genre, rating
